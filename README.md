A simple tool to track the value of a stock portfolio using Python and yfinance. This project fetches real-time stock prices and calculates the total portfolio value dynamically.
 Features:
